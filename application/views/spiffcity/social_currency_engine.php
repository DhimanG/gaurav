<!DOCTYPE html>
<html class="csstransforms no-csstransforms3d csstransitions js cssanimations csstransitions" lang="en">
<head>
      ...
      <div class="span9">
        <div class="navbar navbar-inverse">          
            <ul class="nav">
              ...
              <li ><a href="<?php echo base_url(); ?>spiffcity/home/redeem">Redeem</a></li>
              <li><a href="<?php echo base_url(); ?>spiffcity/home/people">People</a></li>
              <li class="active"><a href="<?php echo base_url(); ?>spiffcity/home/login" id="home-login">Login</a></li>
            </ul>           
        </div>
      </div>
      <!--end: Navigation -->
...
<div id="page-title">
		...
		<div id="page-title-inner">
			...
			<div class="container">
				...
				<h2><i class="ico-cogwheels ico-white"></i>Social Currency Engine</h2>
...
<!-- start: Wrapper -->	
  ...
  <div class="container">
      <div class="row"> 
          <div class="span12 sce-box">
              <img src="<?php echo base_url(); ?>Assets/img/social-currency-engine-l.jpg" alt="social-currency-engine">
      ...
      <div class="row">
       <div class="span4">
        <div class="icons-box">
         <i class="ico-credit ico-white circle-color-full big-color"></i>
         <div class="title"><h3>Spiff Dollars</h3></div>
         <p>
          Earn Spiffs for playing games and social activities you already perform every day.  Get Spiffed!
         </p>
         <div class="clear"></div>
        </div>
       </div>        		
       ...
       <div class="span4">
        <div class="icons-box">
         <i class="ico-shopping-cart ico-white circle-color-full big-color"></i>
         <div class="title"><h3><a href="<?php echo base_url(); ?>spiffcity/home/redeem">Rewards </a></h3></div>
         <p>
     Redeem Spiffs for various rewards like gift cards or exclusive 
discounted deals from favorite merchants.  Get rewarded for your social 
interactions!
         </p>
         <div class="clear"></div>
        </div>
       ...
       <div class="span4">
        <div class="icons-box">
         ...
         <p>
         Connect to your friends and earn rewards from their activities too!
         </p>
         <div class="clear"></div>
        </div>
       </div>
...
<script type="text/javascript" src="<?php echo base_url(); ?>Assets/html/jquery.html"></script>
<script src="<?php echo base_url(); ?>Assets/js/bootstrap.js"></script>
<script src="<?php echo base_url(); ?>Assets/js/isotope.js"></script>
<script src="<?php echo base_url(); ?>Assets/html/jquery_002.html"></script>
