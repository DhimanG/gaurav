...
<div id="wrapper">		 
    ...
    <div class="container">        	
      <ul class="breadcrumb">
        <li><a href="<?php echo base_url(); ?>spiffcity/home">Home</a> <span class="divider">/</span></li>
        <li><a href="<?php echo base_url(); ?>spiffcity/redeem">Redeem</a> <span class="divider">/</span></li>
        <li class="active">Aeropostale</li>
      </ul>			
      <div id="filters">
    ...
    <div class="container">	
      <!-- start: Portfolio -->         
      <div class="row" id="gifcard-wrapper">
        <div class="span12 giftcard-table">
          <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
              ...
              <tr>
                <td class="cardtype-name">Aeropostale</td>
                <td>$25.00</td>
                <td>$21.00</td>
                <td>
                  <select class="span1">
                ...
                <td><button class="btn btn success btn-small" type="button"><i class="icon-shopping-cart icon-white"></i> Add to cart</button></td>                          
              </tr>
              <tr>
                <td class="cardtype-name">Aeropostale</td>
                <td>$25.00</td>
